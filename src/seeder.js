...
const seedData = async () => {
  try {
    ...
    const createdCategories = await Category.insertMany([
      { name: 'Thời Trang Nam', slug: 'thoi-trang-nam', image: 'https://images.unsplash.com/photo-1617137984095-74e4e5e3613f?w=500' },
      { name: 'Thời Trang Nữ', slug: 'thoi-trang-nu', image: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?w=500' },
      { name: 'Phụ Kiện & Giày Dép', slug: 'phu-kien-giay-dep', image: 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?w=500' }
    ]);
